...
class ResolverCacheDataSource extends DataSource {
  ...
  async reset() {
    this.cacheBuster = crypto.randomBytes(20).toString('hex')
...
const withCaching = ({ resolve, cacheKeyItems, ttl }) => async (obj, args, context, info) => {
